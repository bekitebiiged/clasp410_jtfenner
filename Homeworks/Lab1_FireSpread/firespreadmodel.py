...
'''Task 1. Build the model as described in the next section.
Show the results of this test in your Methodology section. This cycle where
we develop and test is called validation. Discuss your implementation and
design in the Methodology section of your report. Implementation and design
means how you built your code AND the decisions you made to build and test
your code. Is everything in a single script? Did you create functions? How
did you design your code to make it easy to test the output?'''
...
def initialize_model_array(init_array, times):
    ...
    buffered_array = np.zeros((times,shape[1]+2,shape[2]+2), dtype=int)
    ...
    buffered_array[0,slice(1,shape[1]+1),slice(1,shape[2]+1)] = init_array
...
forest = initialize_model_array(first_forest, 2)
print(forest)
